...
#all_data_dirs = ['data']
all_data_dirs = ['curves', 'curve_reverse', 'recovery', 'data1', 'data2', 'data_reverse']
img_shape = (160,320,3)
if use_left_right:
	factor = 6
else:
...
model = load_model('best/model_lenet_fliplr_w_crop_0.75_done.h5')
...
history_object = model.fit_generator(train_generator, samples_per_epoch= \
            ...
            nb_val_samples=len(validation_samples)*factor, nb_epoch=12, verbose=1)
